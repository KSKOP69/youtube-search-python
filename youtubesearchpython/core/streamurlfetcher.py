...
class StreamURLFetcherCore(RequestCore):
    ...
    def __init__(self):
        if isYtDLPinstalled:
            ...
            raise Exception('ERROR: yt-dlp is not installed. To use this functionality of youtubesearchpython, yt-dlp must be installed.')
    ...
    def _getDecipheredURLs(self, videoFormats: dict, formatId: int = None) -> None:
        ...
        # See https://github.com/alexmercerind/youtubesearchpython/pull/155#discussion_r790165920
