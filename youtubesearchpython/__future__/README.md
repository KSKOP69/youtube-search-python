# [youtubesearchpython](https://github.com/alexmercerind/youtubesearchpython)

#### Search for YouTube videos, channels & playlists & get video information using link WITHOUT YouTube Data API v3.

##### Important: As of v1.6.1, we no longer use PyTube. You have to install yt-dlp in order to use StreamURLFetcher: `pip install yt-dlp`
...
It is non-blocking & substantially faster than sync youtubesearchpython.
...
You may see the [example](https://github.com/alexmercerind/youtubesearchpython/blob/main/asyncExample.py) for more information.
...
```bash
{
   "result":[
      ...
      },
      {
         ...
         "content":"KSK their music is like being wrapped in a warm blanket on a chilly day.",
         "published":"5 years ago",
         "isLiked":false,
         "authorIsChannelOwner":false,
         "voteStatus":"INDIFFERENT",
